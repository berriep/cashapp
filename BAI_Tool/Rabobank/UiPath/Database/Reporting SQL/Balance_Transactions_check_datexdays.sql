WITH params AS (
  -- Vul hier de gewenste parameters in
  SELECT
    DATE '2025-10-30'        AS target_date,               -- precieze datum
    7                        AS days_back,                 -- aantal dagen terug vanaf target_date
   -- ARRAY['NL48RABO0300002343']::text[] AS ibans           -- leeg = alle IBANs
    ARRAY[]::text[] AS ibans           -- leeg = alle IBANs

),
range AS (
  -- Gebruik target_date minus days_back als start en target_date als end
  SELECT
