...
@bai_bp.route('/admin/users/create', methods=['GET', 'POST'])
@login_required
...
@bai_bp.route('/admin/users/<int:user_id>/edit', methods=['GET', 'POST'])
@login_required
...
@bai_bp.route('/admin/users/<int:user_id>/delete', methods=['POST'])
@login_required
...
@bai_bp.route('/admin/users/<int:user_id>/change-password', methods=['POST'])
@login_required
