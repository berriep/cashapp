...
public class MT940Generator
{
    ...
    private Transaction ParseRabobankTransaction(string json)
    {
        ...
        foreach (string line in lines)
        {
            ...
            else if (trimmedLine.Contains("\"value\":") && transaction.Amount == 0)
            {
    ...
    private string BuildMT940Content(List<Transaction> transactions, Balance balance, string iban, string date)
    {
        ...
        // Calculate opening balance from final balance minus all transactions
        ...
        int blockSize = 5;
        int totalBlocks = Math.Max(1, (int)Math.Ceiling((double)transactions.Count / blockSize));
