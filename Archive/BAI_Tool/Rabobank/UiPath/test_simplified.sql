-- SIMPLIFIED VERSION: Remove complex IBAN filter logic
-- Test if the issue is with the NOT EXISTS array logic
...
daily_transactions AS (
    ...
    AND iban = 'NL48RABO0300002343'  -- Simple IBAN filter instead of complex logic
