...
For Each txRow As DataRow In dt_camt053_tx.Rows
    ...
    If Not minimumRequiredFields Then
        ...
        ' 4. Return Code (/RTRN/) - Only if applicable
        ...
        ' 7. Original Currency/Amount (/OCMT/) - If different from account currency
        ...
        If Not String.IsNullOrEmpty(originalCurrency) AndAlso originalCurrency <> currency AndAlso Not String.IsNullOrEmpty(originalAmount) Then
        ...
        ElseIf proprietaryCode = "626" OrElse proprietaryCode = "625" OrElse proprietaryCode = "1085" OrElse proprietaryCode = "64" Then
